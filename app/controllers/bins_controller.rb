class BinsController < ApplicationController
  ...
  # GET /bins/new
  def new
    @article = Artifle.find(params[:id])
    @bin = @article.bins.new;
  end
  ...
  private
    ...
    def bin_params
      params.require(:bin, :type).permit(:text, :image_file_name, :image_content_type, :image_file_size, :image_updated_at)
    end
end
